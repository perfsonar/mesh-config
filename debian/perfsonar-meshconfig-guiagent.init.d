...
# Default-Stop:      0 1 6
# Short-Description: perfSONAR MeshConfig GUI Agent Daemon
# Description:       The perfSONAR Mesh Config GUI Agent downloads a centralized JSON file
#                    describing the tests a mesh is running, and generates a MaDDash configuration.
### END INIT INFO

# Author: Antoine Delvaux <antoine.delvaux@man.poznan.pl>

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="perfSONAR Mesh Config Agent"
NAME=perfsonar-meshconfig-guiagent
DAEMON=/usr/lib/perfsonar/bin/perfsonar_meshconfig_guiagent
